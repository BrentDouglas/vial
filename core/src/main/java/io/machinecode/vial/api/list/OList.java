...
public interface OList<X> extends OCollection<X>, List<X> {
   ...
   * @return An array according to the semantics of {@link java.util.List#toArray()} if the list
   *     were to contain only the elements of the slice.
   */
   ...
   * @param from First index of the slice to retrieve (inclusive)
   * @param to Last index of the slice to retrieve (exclusive).
   * @return An array according to the semantics of {@link java.util.List#toArray(Object[])} if the
   *     list were to contain only the elements of the slice.
   */
