...
abstract class OBaseList<X> implements OList<X> {
  ...
  static <X> int __indexOf(final X[] values, final int from, final int to, final Object o) {
    return o == null ? __nidx(values, from, to) : __idx(values, from, to, o);
  }

  static <X> int __lastIndexOf(final X[] values, final int from, final int to, final Object o) {
    return o == null ? __lnidx(values, from, to) : __lidx(values, from, to, o);
  }

  static <X> boolean __contains(final X[] values, final int from, final int to, final Object o) {
    final int index = o == null ? __nidx(values, from, to) : __idx(values, from, to, o);
    return index != -1;
  }
  ...
  static <X> int __retainAll(
      final OList<X> list, final X[] values, final int from, int to, final Collection<?> c) {
  ...
  static <X> boolean __equals(
      final Object self, final X[] values, final int from, final int to, final Object o) {
  ...
  static <X> Object[] __toArray(
      final X[] values, final int from, final int to, final int min, final int max) {
  ...
  static <T, X> T[] __toArray(
      final X[] values, final int from, final int to, final int min, final int max, final T[] a) {
    if (from < min || to > max || to < from) throw new IndexOutOfBoundsException();
    final int size = to - from;
    final T[] ret;
    if (a.length < size) {
