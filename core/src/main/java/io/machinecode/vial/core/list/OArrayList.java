...
public class OArrayList<X> extends OBaseList<X> implements RandomAccess, Serializable {
  ...
  public boolean remove(final Object o) {
    final X[] values = this._values;
    final int size = this._size;
    final int index = o == null ? __nidx(values, 0, size) : __idx(values, 0, size, o);
    if (index == -1) {
      return false;
    }
  ...
  public boolean remove(final int from, final int to, final Object o) {
    ...
    final X[] values = this._values;
    final int rel = o == null ? __nidx(values, from, to) : __idx(values, from, to, o);
    if (rel == -1) {
      return false;
    }
  ...
  public Object[] toArray(final int from, final int to) {
    return __toArray(this._values, from, to, 0, this._size);
  }

  @Override
  public <T> T[] toArray(final int from, final int to, final T[] a) {
    return __toArray(this._values, from, to, 0, this._size, a);
  }
  ...
  protected static class SubList<X> extends OBaseList<X> implements RandomAccess {
    final OBaseList<X> _list;
    final int _from;
    int _to;

    SubList(final OBaseList<X> list, final int from, final int to) {
      this._list = list;
      this._from = from;
      this._to = to;
    }
    ...
    public int _removeAll(final int from, final int to, final Collection<?> c) {
      ...
      int _to = _f + to;
      if (_to < _from || _from < _f || to > this._to) throw new IndexOutOfBoundsException();
      final OBaseList<X> list = this._list;
  ...
  public abstract static class _It<X, I, L extends OBaseList<X>> implements OListIterator<I> {
