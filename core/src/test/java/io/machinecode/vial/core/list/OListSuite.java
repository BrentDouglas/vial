...
public class OListSuite extends VialSuite {
    ...
    public static void createSuite(final TestSuite suite, final Class<?> clazz, final String name, final CreateList create) {
    ...
    private static Test stringTestsForOList(final Class<?> clazz, final String name, final Make make) {
    ...
    private static Test charTestsForOList(final Class<?> clazz, final String name, final Make make) {
        return ListTestSuiteBuilder
                .using(new TestCharacterListGenerator() {
                    @Override
    ...
    public void testToTArrayRangeTooShort() {
        final OList<Integer> that = vlist(_0, _1, _2, _3, _4);
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, _3, _4}, that.toArray(0, 5, new Integer[0])));
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, _3}, that.toArray(0, 4, new Integer[0])));
        ...
        assertTrue(Arrays.deepEquals(new Integer[]{_1, _2, _3, _4}, that.toArray(1, 5, new Integer[0])));
    ...
    public void testToTArrayRangeSameLength() {
        final OList<Integer> that = vlist(_0, _1, _2, _3, _4);
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, _3, _4}, that.toArray(0, 5, new Integer[5])));
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, _3}, that.toArray(0, 4, new Integer[4])));
        ...
        assertTrue(Arrays.deepEquals(new Integer[]{_1, _2, _3, _4}, that.toArray(1, 5, new Integer[4])));
    ...
    public void testToTArrayRangeLonger() {
        final OList<Integer> that = vlist(_0, _1, _2, _3, _4);
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, _3, _4, null}, that.toArray(0, 5, new Integer[6])));
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, _3, null}, that.toArray(0, 4, new Integer[5])));
        assertTrue(Arrays.deepEquals(new Integer[]{_0, _1, _2, null}, that.toArray(0, 3, new Integer[4])));
        ...
        assertTrue(Arrays.deepEquals(new Integer[]{_1, _2, _3, _4, null}, that.toArray(1, 5, new Integer[5])));
        assertTrue(Arrays.deepEquals(new Integer[]{_1, _2, _3, null}, that.toArray(1, 4, new Integer[4])));
        ...
        assertTrue(Arrays.deepEquals(new Integer[]{_2, _3, _4, null}, that.toArray(2, 5, new Integer[4])));
    ...
    public void testIteratorBeforePrevious() {
        try {
            final OListIterator<Integer> it = vlist(_0, _1)
                    .iterator()
                    .before();
            it.previous();
            fail();
